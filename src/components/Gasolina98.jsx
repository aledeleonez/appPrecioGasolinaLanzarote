        ...
        <div key={index} className='col p-2'>
          ...
          >
            <div className='card-body text-center'>
              ...
              <h6 className='mb-2 text-muted' style={{ fontSize: "14px" }}>
                {item.Horario}
              </h6>
              <hr />
              <p>Localidad: {item.Localidad}</p>
              <p className='text-lowercase text-capitalize '>
              ...
              <p
                ...
                className={`${
                  esIgual(
                    gasolineras[0]["Precio Gasolina 98 E5"],
                    item["Precio Gasolina 98 E5"]
                  )
                    ? "text-success"
                    : ""
                }`}
              >
                Precio Gasolina 98: {item["Precio Gasolina 98 E5"]} €
              </p>
              <p>Precio Gasolina 95: {item["Precio Gasolina 95 E5"]} € </p>
              <p>Precio Gasóleo: {item["Precio Gasoleo A"]} € </p>
            </div>
          </div>
        </div>
      ))}
